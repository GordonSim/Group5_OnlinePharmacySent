        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AspNetUserIdId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Allergy_Medicine_MedicineId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "bd2bcf0c-20db-474f-8407-5a6b159518bb", null, "UserId", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Customer",
                columns: new[] { "Id", "Address", "AspNetUserIdId", "Email", "Name", "Password", "PhoneNumber" },
                values: new object[] { 1, "789 Admin St, Singapore", "3781efa7-66dc-47f0-860f-e506d04102e4", "admin@example.com", "Admin UserId", "hashed_password_3", "90011234" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "A reflex action to clear airways of mucus, dust, or foreign particles.", "Cough" },
                    { 2, "Frequent, loose, or watery stools, often caused by an infection.", "Diarrhea" },
                    { 3, "Symptoms affecting the eyes, such as dryness or irritation.", "Eye Care" },
                    { 4, "A common viral infection causing fever, chills, and muscle aches.", "Flu" },
                    { 5, "Discomfort in the stomach associated with difficulty digesting food.", "Indigestion" },
                    { 6, "Physical discomfort or suffering caused by injury or illness.", "Pain" }
                });

            migrationBuilder.InsertData(
                table: "Allergy",
                columns: new[] { "Id", "CustomerId", "MedicineId", "Reaction", "Severity" },
                values: new object[,]
                {
                    { 1, 1, 4, "Swelling and Rash", "High" },
                    { 2, 1, 3, "Itchy Skin", "Mild" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Order",
                columns: new[] { "Id", "CustomerId", "OrderDate", "PaymentStatus", "ShippingAddress", "TotalPrice" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 1, 15, 19, 15, 0, 0, DateTimeKind.Unspecified), "Paid", "123 Main St, Singapore", 99.99f },
                    { 2, 1, new DateTime(2025, 1, 16, 10, 15, 0, 0, DateTimeKind.Unspecified), "Pending", "456 Marina Bay, Singapore", 89.5f },
                    { 3, 1, new DateTime(2025, 1, 17, 16, 45, 0, 0, DateTimeKind.Unspecified), "Failed", "789 Tampines Street, Singapore", 120.75f }
                });

            migrationBuilder.InsertData(
                table: "OrderItem",
                columns: new[] { "Id", "ItemPrice", "MedicineId", "OrderId", "Qty" },
                values: new object[,]
                {
                    { 1, 5.99f, 1, 1, 2 },
                    { 2, 7.49f, 2, 1, 1 },
